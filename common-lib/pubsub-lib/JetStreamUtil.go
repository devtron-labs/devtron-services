...
const (
	...
	INFRASTRACTURE_INSTALLATION_SUCCESS_TOPIC           string = "INFRASTRACTURE_INSTALLATION_SUCCESS_TOPIC"
	INFRASTRACTURE_INSTALLATION_SUCCESS_GROUP           string = "INFRASTRACTURE_INSTALLATION_SUCCESS_GROUP"
	INFRASTRACTURE_INSTALLATION_SUCCESS_DURABLE         string = "INFRASTRACTURE_INSTALLATION_SUCCESS_DURABLE"
	INFRASTRACTURE_INSTALLATION_DELETE_SUCCESS_TOPIC    string = "INFRASTRACTURE_INSTALLATION_DELETE_SUCCESS_TOPIC"
	INFRASTRACTURE_INSTALLATION_DELETE_SUCCESS_GROUP    string = "INFRASTRACTURE_INSTALLATION_DELETE_SUCCESS_GROUP"
	INFRASTRACTURE_INSTALLATION_DELETE_SUCCESS_DURABLE  string = "INFRASTRACTURE_INSTALLATION_DELETE_SUCCESS_DURABLE"
	INFRASTRUCTURE_INSTALLATION_RELEASE_INSTALL_TOPIC   string = "INFRASTRUCTURE_INSTALLATION_RELEASE_INSTALL_TOPIC"
	INFRASTRUCTURE_INSTALLATION_RELEASE_INSTALL_GROUP   string = "INFRASTRUCTURE_INSTALLATION_RELEASE_INSTALL_GROUP"
	INFRASTRUCTURE_INSTALLATION_RELEASE_INSTALL_DURABLE string = "INFRASTRUCTURE_INSTALLATION_RELEASE_INSTALL_DURABLE"
)
...
var natsTopicMapping = map[string]NatsTopic{
	...
	INFRASTRUCTURE_INSTALLATION_RELEASE_INSTALL_TOPIC: {topicName: INFRASTRUCTURE_INSTALLATION_RELEASE_INSTALL_TOPIC, streamName: ORCHESTRATOR_STREAM, queueName: INFRASTRUCTURE_INSTALLATION_RELEASE_INSTALL_GROUP, consumerName: INFRASTRUCTURE_INSTALLATION_RELEASE_INSTALL_DURABLE},
}
...
var NatsConsumerWiseConfigMapping = map[string]NatsConsumerConfig{
	...
	INFRASTRUCTURE_INSTALLATION_RELEASE_INSTALL_DURABLE: {},
}
