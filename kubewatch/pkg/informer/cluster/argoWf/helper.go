...
func (impl *InformerImpl) getStoppableCiArgoWfs() []int {
	return maps.Keys(impl.argoWfCiInformerStopper)
}

func (impl *InformerImpl) getStoppableCdArgoWfs() []int {
...
func (impl *InformerImpl) startCiArgoWfInformer(clusterInfo *repository.Cluster) error {
...
func (impl *InformerImpl) startCdArgoWfInformer(clusterInfo *repository.Cluster) error {
