	...
	tests := []struct {
		...
		{name: "Eval_false",
			args: args{condition: &ConditionObject{
				...
				ConditionalOperator: ">",
				ConditionalValue:    "10",
			}, variables: []*VariableObject{{Name: "age", Value: "8", Format: FormatTypeNumber}}},
			wantErr:    false,
			wantStatus: false},
		{name: "eval_true",
			args: args{condition: &ConditionObject{
				...
				ConditionalOperator: ">",
				ConditionalValue:    "10",
			}, variables: []*VariableObject{{Name: "age", Value: "12", Format: FormatTypeNumber}}},
			wantErr:    false,
			wantStatus: true},
		{name: "Eval_true_date",
			args: args{condition: &ConditionObject{
			...
			}, variables: []*VariableObject{{Name: "today", Value: "Tue Apr 12 13:55:21 IST 2022", Format: FormatTypeDate}}},
			wantErr:    false,
			wantStatus: true},
		{name: "Eval_false_date",
			args: args{condition: &ConditionObject{
				...
				ConditionalOperator: "<",
				ConditionalValue:    "'Tue Apr 10 13:55:21 IST 2022'",
			}, variables: []*VariableObject{{Name: "today", Value: "'Tue Apr 8 13:55:21 IST 2022'", Format: FormatTypeDate}}},
			wantErr:    false,
			wantStatus: false},
	}
